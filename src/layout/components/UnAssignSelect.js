          ...
          >
            ...
            {value.map((option) => (
              <div
                ...
                onClick={() => {
                  ...
                  handleDelete(selectedValue, option, !checked);
                  setVisible(false);
                }}
              >
                <div style={{ width: 20 }}>
            ...
            >
              <TextField
                ...
                placeholder="Add new field in DB"
                // InputLabelProps={{
                //   shrink: true,
                // }}
              ...
              <AddCircleOutlineOutlinedIcon
                style={{ cursor: "pointer", margin: "auto", marginLeft: 7 }}
                onClick={() => {
                  handleAdd();
                }}
              />
