...
export default function CompanyDetailCard(props) {
    ...
    //     return
    // }, [page, sortFilter, totalCountries,toggleCheck]);
    ...
    return (
        ...
        // <div className={classes.main} onClick={onCompanySelect}  {...props}  >
        //     {
        //         // <div className={classes.item} style={{ borderRight: `2px solid ${grey[300]}`, marginRight: 5, minWidth: '25%' }}>
        ...
        //             {
        //                 dataset &&
        //                 <CustomIcon icon={<Tooltip title={dataset}><LocationOn /></Tooltip>} />
        //             }
        //             {
        //                 main_line_number &&
        //                 <a href={`tel:${main_line_number}`}>
        ...
        //         <OutlineBtn value="US 1 - 2k" style={{ zIndex: -1, margin: "0 auto" }} /> */}
        ...
        //             style={{ zIndex: -1, backgroundColor: score["color"], color: '#FFF', fontSize: 10, fontWeight: '600', margin: "0 auto", border: "none" }} />
        //     </div>
        // </div>
    );
}
