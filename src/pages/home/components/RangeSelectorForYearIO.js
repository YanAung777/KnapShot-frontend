...
export default function RangeSelector(props) {
    ...
    const { selectedDataset, selectedFilename, userFavCompFilter, userProductServiceFilter, userDigitalEngagementFilter,yearIORangeFilter,
        userSubPartner,userPartner, totalCountries, userCompanyExpertiseFilter, userCategoryFilter, userEmpSizeFilter, userCompanyFilter } = state
