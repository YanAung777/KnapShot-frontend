    ...
    return (
        <div className={classes.main}>
            ...
            <div className={classes.item} style={{ justifyContent: 'flex-end', alignItems: 'flex-end', minWidth: '30%' }}>
                <Text value="Ads Expenditure" />
                <OutlineBtn value="US 1 - 2k" />
                <Text value="Digital Engagement" style={{ marginTop: 10 }} />
                <OutlineBtn
                    value={`/10 | ${score["type"]}`}
                    score={<span style={{ fontSize: 13 }}>{overall_knapshot_score}</span>}
                    style={{ backgroundColor: score["color"], color: '#FFF', fontSize: 10, fontWeight: '600' }} />
            </div>
        </div>
    );
}
