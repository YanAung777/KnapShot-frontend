...
export default function CompanyLists(props) {
    ...
    const { lists, count, page, activeIndex, loading } = state.selectedDigitalEngagementCompany;
    ...
    const loadMore = () => {
        ...
        dispatch({ type: "setSelectedDigitalEngagementCompanyPage", page: page + 1 });
    }
    ...
    const checkCount = () => {
        if (page * 10 < count) {  return  loading ?
